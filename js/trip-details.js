...
const tripsData = [
    {
        ...
        fullDescription: "ทริปพิเศษที่จะพาคุณไปสัมผัสความงดงามของธรรมชาติริมคลองบางมด พายเรือคายัคลัดเลาะผ่านสวนมะพร้าวเขียวขจี ชมวิถีชีวิตชาวบ้านที่ยังคงใช้ชีวิตแบบดั้งเดิม พร้อมเรียนรู้การทำขนมไทยโบราณจากปราชญ์ชาวบ้าน",
        price: "800 บาท/คน",
    ...
    {
        id: 2,
        name: "ทริปปั่นจักรยานชมสวนผลไม้",
    ...
    {
        id: 7,
        name: "ทริปชมพระอาทิตย์ตกริมคลอง",
    ...
    {
        id: 9,
        name: "ทริปเรียนรู้การทำผ้าบาติก",
    ...
    {
        id: 10,
        name: "ทริปเรียนรู้การทำขนมไทยโบราณ",
    ...
    {
        id: 11,
        name: "ทริปเรียนรู้การทำเครื่องจักสาน",
    ...
    {
        id: 12,
        name: "ทริปเรียนรู้การทำน้ำสมุนไพร",
    ...
    {
        id: 13,
        name: "ทริปเรียนรู้การทำเครื่องเงิน",
    ...
    {
        id: 14,
        name: "ทริปเรียนรู้การทำเครื่องทอง",
    ...
    {
        id: 15,
        name: "ทริปเรียนรู้การทำเครื่องแก้ว",
    ...
    {
        id: 16,
        name: "ทริปเรียนรู้การทำเครื่องหนัง",
    ...
    {
        id: 17,
        name: "ทริปเรียนรู้การทำเครื่องไม้",
    ...
    {
        id: 18,
        name: "ทริปเรียนรู้การทำเครื่องหิน",
...
function showTripDetails(tripId) {
    ...
    gallery.innerHTML = trip.gallery.map(img => 
        `<img src="${img}" alt="ภาพทริป" class="gallery-thumb" onclick="openGallery('${img}')">`
    ).join('');
